...
<body>
    ...
    <div class="container-main" style="padding-bottom: 3%;">
            ...
            <center><div style="width: 30%;padding: 3%;margin-bottom: -30px;">
            <b><h style="font-size: 250%;font-weight: 1500;">อ้ะสุ่มให้!</h></b>
            </div></center>
            ...
            <?php
                ...
                $query1 = " SELECT * FROM food,restaurant 
                            WHERE restaurant.restaurant_id = food.restaurant_id
                            AND food.active = '1'
                            ORDER BY RAND()
                            LIMIT 3;
                            ";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    $outputRand .= '
                   <div class="container-inside" style="scale: 110%;margin-left: 3%;margin-right: 3%;cursor: pointer;">
