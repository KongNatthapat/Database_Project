...
<body onload="findFood('<?php echo $_SESSION['kw']; ?> ')">
    <!-- Topbar Start -->
    ...
    <!-- Navbar End -->
            ...
            <div style="width: 30%;padding: 3%;margin-bottom: -20px;">
                <center><b><h style="font-size: 150%;font-weight: 1500;" id="searchcount">เมนูอาหารแนะนำ</h></b></center>
            </div>
            <hr style="width:80%;text-align:left;margin-left:0;margin: auto;">
            <br>
            <div id="result" onclick="findFood('<?php echo $_SESSION['kw'];?> ')"  ></div>


</body>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
    <script src="src/navbar_js.js"></script>
    <script src="src/kinraidee.js"></script>
